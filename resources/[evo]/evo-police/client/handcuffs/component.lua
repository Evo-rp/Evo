...
AddEventHandler("Core:Shared:Ready", function()
	exports["evo-base"]:RequestDependencies("Handcuffs", {
		"Callbacks",
		"Inventory",
		"PedInteraction",
		"Minigame",
			...
			if not IsPedInAnyVehicle(LocalPlayer.state.ped, true) then
				if _cuffPromise == nil then
					...
					then
						...
						Minigame.Play:RoundSkillbar(2.0 + (0.2 * (_attempts or 1)), 5 - _attempts, {
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["evo-base"]:RegisterComponent("Handcuffs", _HANDCUFFS)
end)
