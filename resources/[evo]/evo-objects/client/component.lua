...
AddEventHandler("Core:Shared:Ready", function()
	exports["evo-base"]:RequestDependencies("Objects", {
		"Callbacks",
		"Notification",
		"Targeting",
		"Inventory",
		...
		if #error > 0 then
			exports["evo-base"]:FetchComponent("Logger"):Critical("Objects", "Failed To Load All Dependencies")
			return
		end
			...
			},
			{
				...
				isEnabled = function(data, entity)
					...
					return eState.isPlacedProp
						and (
							LocalPlayer.state.IsStaff
							or LocalPlayer.state.isAdmin
							or LocalPlayer.state.Character:GetData("SID") == _placedProps[entState.objectId].creator
						)
				end,
			},
			{
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["evo-base"]:RegisterComponent("Objects", _OBJECTS)
end)
