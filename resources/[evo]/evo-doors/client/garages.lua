function CreateGaragePolyZones()
	...
	Polyzone.Create:Box("doors_bennys_side_garage_2", vector3(-215.9706, -1313.4753, 31.3005), 10.0, 10.0, {
		heading = 2,
		--debugPoly = true,
		minZ = 29.3005,
		maxZ = 34.3005,
	...
	Polyzone.Create:Box("doors_bennys_main_garage", vector3(-230.6841, -1327.0823, 31.3005), 10.0, 10.0, {
		heading = 90,
		--debugPoly = true,
		minZ = 29.3005,
		maxZ = 34.3005,
