...
local weaponCheaters = {
	...
	[GetHashKey("WEAPON_TASER")] = "Stungun",
	...
	[GetHashKey("WEAPON_FADEBFKNIFE")] = "butterfly knife", 
	[GetHashKey("WEAPON_DRAGON_KATANA_BLUE")] = "Katana Blue",
	[GetHashKey("WEAPON_DRAGON_KATANA_PURPLE")] = "Katana Purple",
	[GetHashKey("WEAPON_DRAGON_KATANA_RED")] = "Katana red",
	[GetHashKey("WEAPON_KATANA_2")] = "Katana",
	[GetHashKey("WEAPON_SCYTHE")] = "SCYTHE",
...
AddEventHandler("Core:Shared:Ready", function()
	exports["evo-base"]:RequestDependencies("Weapons", {
		"Fetch",
		"Logger",
		"Inventory",
		"Weapons",
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["evo-base"]:RegisterComponent("Weapons", WEAPONS)
end)
