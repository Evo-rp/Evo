...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["evo-base"]:RegisterComponent("Queue", QUEUE)
end)

AddEventHandler("Queue:Shared:DependencyUpdate", RetrieveComponents)
function RetrieveComponents()
	c = exports["evo-base"]:FetchComponent("Config")
	Database = exports["evo-base"]:FetchComponent("Database")
	WebAPI = exports["evo-base"]:FetchComponent("WebAPI")
	Punishment = exports["evo-base"]:FetchComponent("Punishment")
	Queue = exports["evo-base"]:FetchComponent("Queue")
	Convar = exports["evo-base"]:FetchComponent("Convar")
...
AddEventHandler("Core:Shared:Ready", function()
	exports["evo-base"]:RequestDependencies("Queue", {
		"Config",
		"Database",
		"WebAPI",
		"Punishment",
...
Citizen.CreateThread(function()
	...
	if not exports["evo-base"]:FetchComponent("WebAPI").Enabled then
