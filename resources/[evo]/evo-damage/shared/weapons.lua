...
Config.Weapons = {
	...
	[`WEAPON_DRAGON_KATANA_BLUE`] = { minor = false, violent = true },
	[`WEAPON_DRAGON_KATANA_PURPLE`] = { minor = false, violent = true },
	[`WEAPON_DRAGON_KATANA_RED`] = { minor = false, violent = true }, 
	[`WEAPON_KATANA_2`] = { minor = false, violent = true }, 
	[`WEAPON_SCYTHE`] = { minor = false, violent = true }, 
