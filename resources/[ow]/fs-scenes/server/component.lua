...
function RetrieveComponents()
	...
	Scenes = exports["fs-base"]:FetchComponent("Scenes")
end

AddEventHandler("Core:Shared:Ready", function()
	exports["fs-base"]:RequestDependencies("Scenes", {
		"Fetch",
		"Utils",
		"Execute",
		"Chat",
		...
		if #error > 0 then
			exports["fs-base"]:FetchComponent("Logger"):Critical("Scenes", "Failed To Load All Dependencies")
			return
		end
		RetrieveComponents()
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["fs-base"]:RegisterComponent("Scenes", _SCENES)
end)
