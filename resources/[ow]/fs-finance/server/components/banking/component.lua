...
AddEventHandler("Core:Shared:Ready", function()
	exports["fs-base"]:RequestDependencies("Banking", {
		"Fetch",
		"Utils",
		"Execute",
		"Chat",
		...
		if #error > 0 then
			exports["fs-base"]:FetchComponent("Logger"):Critical("Banking", "Failed To Load All Dependencies")
			return
		end
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["fs-base"]:RegisterComponent("Banking", _BANKING)
end)
