...
function RetrieveComponents()
	...
	Default = exports["fs-base"]:FetchComponent("Default")
	Inventory = exports["fs-base"]:FetchComponent("Inventory")
	EntityTypes = exports["fs-base"]:FetchComponent("EntityTypes")
	...
	Robbery = exports["fs-base"]:FetchComponent("Robbery")
end

AddEventHandler("Core:Shared:Ready", function()
	exports["fs-base"]:RequestDependencies("Inventory", {
		"Database",
		"Callbacks",
		"Sequence",
		"Fetch",
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["fs-base"]:RegisterComponent("Inventory", INVENTORY)
end)
