...
AddEventHandler("Core:Shared:Ready", function()
	exports["fs-base"]:RequestDependencies("Objects", {
		"Callbacks",
		"Notification",
		"Targeting",
		"Inventory",
		...
		if #error > 0 then
			exports["fs-base"]:FetchComponent("Logger"):Critical("Objects", "Failed To Load All Dependencies")
			return
		end
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["fs-base"]:RegisterComponent("Objects", _OBJECTS)
end)
