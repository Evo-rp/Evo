...
AddEventHandler("Core:Shared:Ready", function()
	exports["fs-base"]:RequestDependencies("ObjectPlacer", {
        "Notification",
        "Targeting",
        "ObjectPlacer",
	}, function(error)
		if #error > 0 then 
            exports["fs-base"]:FetchComponent("Logger"):Critical("ObjectPlacer", "Failed To Load All Dependencies")
			return
		end
		RetrieveComponents()
	end)
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["fs-base"]:RegisterComponent("ObjectPlacer", _PLACER)
end)