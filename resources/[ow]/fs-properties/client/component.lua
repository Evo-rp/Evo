...
function RetrieveComponents()
	...
	Wardrobe = exports["fs-base"]:FetchComponent("Wardrobe")
	...
	InfoOverlay = exports["fs-base"]:FetchComponent("InfoOverlay")
end

AddEventHandler("Core:Shared:Ready", function()
	exports["fs-base"]:RequestDependencies("Properties", {
		"Callbacks",
		"Inventory",
		"Logger",
		"Utils",
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["fs-base"]:RegisterComponent("Properties", PROPERTIES)
end)
