...
function RetrieveComponents()
    ...
    Dealerships = exports['fs-base']:FetchComponent('Dealerships')
...
AddEventHandler('Core:Shared:Ready', function()
    exports['fs-base']:RequestDependencies('Dealerships', {
        'Database',
        'Callbacks',
        'Logger',
        'Utils',
...
AddEventHandler('Proxy:Shared:RegisterReady', function()
    exports['fs-base']:RegisterComponent('Dealerships', DEALERSHIPS)
end)
