...
function RetrieveComponents()
	...
	Scenes = exports["evo-base"]:FetchComponent("Scenes")
end

AddEventHandler("Core:Shared:Ready", function()
	exports["evo-base"]:RequestDependencies("Scenes", {
		"Fetch",
		"Utils",
		"Execute",
		"Chat",
		...
		if #error > 0 then
			exports["evo-base"]:FetchComponent("Logger"):Critical("Scenes", "Failed To Load All Dependencies")
			return
		end
		RetrieveComponents()
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["evo-base"]:RegisterComponent("Scenes", _SCENES)
end)
