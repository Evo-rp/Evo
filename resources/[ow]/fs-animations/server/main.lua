...
AddEventHandler("Core:Shared:Ready", function()
	exports["fs-base"]:RequestDependencies("Animations", {
		"Database",
		"Utils",
		"Callbacks",
		"Chat",
...
function RegisterCallbacks()
	Callbacks:RegisterServerCallback("Animations:UpdatePedFeatures", function(source, data, cb)
		local _src = source
		local player = exports["fs-base"]:FetchComponent("Fetch"):Source(_src)
		local char = player:GetData("Character")
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["fs-base"]:RegisterComponent("Animations", ANIMATIONS)
end)
