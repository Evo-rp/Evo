...
function RetrieveComponents()
	...
	Casino = exports["evo-base"]:FetchComponent("Casino")
	Loot = exports["evo-base"]:FetchComponent("Loot")
end

AddEventHandler("Core:Shared:Ready", function()
	exports["evo-base"]:RequestDependencies("Casino", {
		"Fetch",
		"Utils",
		"Execute",
		"Chat",
		...
		if #error > 0 then
			exports["evo-base"]:FetchComponent("Logger"):Critical("Casino", "Failed To Load All Dependencies")
			return
		end
		RetrieveComponents()
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["evo-base"]:RegisterComponent("Casino", _CASINO)
end)
