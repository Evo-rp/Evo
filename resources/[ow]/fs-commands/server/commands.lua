...
function RetrieveComponents()
	...
	Config = exports["fs-base"]:FetchComponent("Config")
...
AddEventHandler("Core:Shared:Ready", function()
	exports["fs-base"]:RequestDependencies("Commands", {
		"Chat",
		"Callbacks",
		"Config",
		"Sounds",
...
function RegisterChatCommands()
	...
	-- 	local data = exports["fs-base"]:FetchComponent("Punishment"):Kick(tonumber(args[1]), args[2], source)
	...
	-- 			exports["fs-base"]:FetchComponent("Punishment"):Kick(t:GetData("Source"), args[2], source)
	-- 		else
	...
	-- 	exports["fs-base"]:FetchComponent("Punishment").Unban:BanID(args[1], source)
	-- end, {
	-- 	help = "Unban Player",
	-- 	params = {
	-- 		{
	...
	-- 		exports["fs-base"]:FetchComponent("Punishment").Unban:Identifier(args[2], source)
	-- 	elseif type == "account" then
	-- 		exports["fs-base"]:FetchComponent("Punishment").Unban:AccountID(tonumber(args[2]), source)
	-- 	end
	-- end, {
	-- 	help = "Unban Site ID",
	-- 	params = {
	...
	-- 			exports["fs-base"]:FetchComponent("Punishment").Ban:Source(targetSource, days, args[3], source)
	-- 		else
	...
	-- 			if (days >= 1 and days <= 7) or (player.Permissions:IsAdmin() and days >= -1 and days <= 90) then
	-- 				exports["fs-base"]:FetchComponent("Punishment").Ban:Source(t:GetData("Source"), days, args[3], source)
	-- 			else
	-- 				Chat.Send.System:Single(source, "Invalid Time")
	-- 			end
	-- 		else
	...
	-- 			elseif type == "account" then
	-- 				local res =
	-- 					exports["fs-base"]:FetchComponent("Punishment").Ban:AccountID(target, days, args[4], source)
	-- 				if res and res.success then
