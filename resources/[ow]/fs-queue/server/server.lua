...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["fs-base"]:RegisterComponent("Queue", QUEUE)
end)

AddEventHandler("Queue:Shared:DependencyUpdate", RetrieveComponents)
function RetrieveComponents()
	c = exports["fs-base"]:FetchComponent("Config")
	Database = exports["fs-base"]:FetchComponent("Database")
	WebAPI = exports["fs-base"]:FetchComponent("WebAPI")
	Punishment = exports["fs-base"]:FetchComponent("Punishment")
	Queue = exports["fs-base"]:FetchComponent("Queue")
	Convar = exports["fs-base"]:FetchComponent("Convar")
...
AddEventHandler("Core:Shared:Ready", function()
	exports["fs-base"]:RequestDependencies("Queue", {
		"Config",
		"Database",
		"WebAPI",
		"Punishment",
...
Citizen.CreateThread(function()
	...
	if not exports["fs-base"]:FetchComponent("WebAPI").Enabled then
