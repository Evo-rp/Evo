...
function RetrieveComponents()
    ...
    Dealerships = exports['evo-base']:FetchComponent('Dealerships')
    ...
    Default = exports['evo-base']:FetchComponent('Default')
    Chat = exports['evo-base']:FetchComponent('Chat')
    MDT = exports['evo-base']:FetchComponent('MDT')
end

AddEventHandler('Core:Shared:Ready', function()
    exports['evo-base']:RequestDependencies('Dealerships', {
        'Database',
        'Callbacks',
        'Logger',
        'Utils',
...
AddEventHandler('Proxy:Shared:RegisterReady', function()
    exports['evo-base']:RegisterComponent('Dealerships', DEALERSHIPS)
end)
