...
function RetrieveComponents()
	...
	EntityTypes = exports["evo-base"]:FetchComponent("EntityTypes")
...
AddEventHandler("Core:Shared:Ready", function()
	exports["evo-base"]:RequestDependencies("Inventory", {
		"Database",
		"Callbacks",
		"Sequence",
		"Fetch",
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["evo-base"]:RegisterComponent("Inventory", INVENTORY)
end)
