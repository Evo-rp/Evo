...
function RetrieveComponents()
    ...
    Billboards = exports["fs-base"]:FetchComponent("Billboards")
    Regex = exports["fs-base"]:FetchComponent("Regex")
end

AddEventHandler("Core:Shared:Ready", function()
	exports["fs-base"]:RequestDependencies("Billboards", {
		"Fetch",
		"Utils",
        "Execute",
        "Chat",
		...
		if #error > 0 then 
            exports["fs-base"]:FetchComponent("Logger"):Critical("Billboards", "Failed To Load All Dependencies")
			return
		end
		RetrieveComponents()
...
AddEventHandler("Proxy:Shared:RegisterReady", function(component)
	exports["fs-base"]:RegisterComponent("Billboards", _BILLBOARDS)
end)
